...
public class CurrentAppsRunningService extends IntentService {
	private AppContextData appContextData;
	private List<String> appsRunning;
	
	public CurrentAppsRunningService() {
		super("CurrentAppsRunningService");
		
		appsRunning = new ArrayList<String>();
		//This is a default contextual situation, ideally we should be able to use real context
		appContextData = new AppContextData("John.Doe@gmail.com", "work", "research", "morning", "personal", appsRunning);
	}
...
//		return activityManagerMethodOfCollectingAppData();
		return usageStatsManagerMethodOfCollectingAppData();
	}
